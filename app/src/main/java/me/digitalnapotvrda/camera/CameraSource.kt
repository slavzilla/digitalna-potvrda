...
class CameraSource(private val graphicOverlay: GraphicOverlay) {
    ...
    private fun  hasFlash(): Boolean {
        ...
        val parameters: Camera.Parameters = try {
            camera!!.parameters
...
//            )
     ...
     */
    private inner class FrameProcessingRunnable constructor() : Runnable {
    ...
    companion object {
        ...
        private const val MAX_CAMERA_PREVIEW_WIDTH = 1600
        ...
        private fun selectSizePair(camera: Camera, displayAspectRatioInLandscape: Float): CameraSizePair? {
            ...
            for (sizePair in validPreviewSizes) {
                ...
                Timber.d("size width height are ${previewSize.width} ${previewSize.height} | $previewAspectRatio and $aspectRatioDiff")
